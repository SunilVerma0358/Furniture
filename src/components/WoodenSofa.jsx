        ...
        <div className="container max-w-[1320px] px-3 mx-auto pt-6 pb-7 sm:pt-[40px] md:pt-[64px]">
          <div className="flex flex-row flex-wrap -mx-3">
            <div className="w-full md:w-4/12 px-3">
              ...
              <h2 className=" font-Poppins font-bold text-[#243040] text-[30px] lg:text-[32px] xl:text-[35px] leading-normal  lg:max-w-[436px] pt-4 sm:pt-[24px] pb-[20px] sm:pb-[40px] lg:pb-[53px]">
